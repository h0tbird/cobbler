...
cobbler system edit --name=$h --interface=br1_3 --interface-type=bridge --bridge-opts="STP=yes" --static=1
cobbler system edit --name=$h --interface=br1_6 --interface-type=bridge --bridge-opts="STP=yes" --static=1
